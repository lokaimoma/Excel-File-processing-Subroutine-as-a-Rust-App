...
async fn main() {
    ...
    // let file = reader::xlsx::read(r#".\data_\0329 giao hang.xlsx"#).unwrap();
    ...
    //     "Total cells: {}, Expects: {}",
    //     a.len(),
    //     sheet.get_highest_column() * sheet.get_highest_row()
    // );
    // println!("Cells values: {:?}", a);
    // let a: Vec<_> = a
    //     .chunks_exact(sheet.get_highest_column() as usize)
    //     .collect();
    // println!(
    //     "New size after chunk_exact: {}, Expected: {}",
    //     a.len(),
    //     sheet.get_highest_row()
    // );
    // println!(
    //     "Size of each chunk: {}, Expected: {}",
    //     a[0].len(),
    //     sheet.get_highest_column()
    // );
    // println!("Last row: {:?}", a[a.len() - 1]);
